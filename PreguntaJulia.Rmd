...
```
```{r}
grafico_caja1 <- ggplot(data, aes(x = as.factor(Year))) +
  geom_boxplot(aes(y = Depression), fill = "blue", alpha = 0.7) +
  labs(title = "Distribución de Depression por año",
       x = "Año",
       y = "Valor") +
  scale_fill_manual(values = c("blue", "green", "red"))
...
grafico_caja <- ggplot(data, aes(x = as.factor(Year))) +
  geom_boxplot(aes(y = Alcohol.use.disorders), fill = "green", alpha = 0.7) +
  labs(title = "Alcohol.use.disorders por año",
       x = "Año",
       y = "Valor") +
  scale_fill_manual(values = c("blue", "green", "red"))
...
grafico_caja <- ggplot(data, aes(x = as.factor(Year))) +
  geom_boxplot(aes(y = SuicideRate), fill = "red", alpha = 0.7) +
  labs(title = "Distribución de Depression SuicideRate por año",
       x = "Año",
       y = "Valor") +
  scale_fill_manual(values = c("blue", "green", "red"))
...
# Filtrar columnas relevantes y renombrarlas
...
# Convertir a tibble para facilitar la manipulación de datos
data_st <- as_tibble(data_st)

# Visualizar los datos
ggplot(data_st, aes(x = Year, y = Numero_de_suicidios)) +
  geom_line() +
  labs(title = "Número de suicidios por año",
       x = "Año",
       y = "Número de suicidios")

# Ajustar un modelo de series temporales (por ejemplo, ARIMA)
modelo_arima <- auto.arima(data_st$Numero_de_suicidios)

# Realizar predicciones para los próximos 5 años
