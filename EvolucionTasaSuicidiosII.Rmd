...
```{r}
suicide_data <- read.csv("C:/Users/Miguel Matamoros/Downloads/dataScience-main/dataScience-main/data/1.OMSTasaMortalidadSuicidio/tasa_suicidio_por_pais.csv")
