...
También, hemos observado que la columna "Year"es un objetos de tipo "Character" y es necesario que la variable "Year" sea de tipo "Integer" y que el resto sea de tipo "Double", pues representan porcentajes, para que el sistema entienda bien dichos datos. 


```{r}
# Columna 'Year' a tipo Integer y el resto a Double
datosMH$Year <- as.integer(datosMH$Year)
